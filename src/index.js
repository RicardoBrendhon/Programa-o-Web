...
class App extends React.Component {
    constructor(props) {
        ...
        indice: 0
         ...
         this.jogadores = [
            {nome: "Diego", time: "Corinthians", nacionalidades:"Alemanha"},
            {nome: "Bruno", time: "vasco", nacionalidades:"Brasil"},
            {nome: "Gabriel", time: "santos", nacionalidades:"Russia"},
            {nome: "Ricardo", time: "Goias", nacionalidades:"Argentina"},
            {nome: "Pedro", time: "Vila", nacionalidades:"Africa"},
        ]
    ...
    render() {
        return(
            <div className="container">
                ...
                <br/>
                {this.jogadores[this.state.indice].nacionalidades}
